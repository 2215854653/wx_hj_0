...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/hj/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/hj/menu/js/jquery.js"></script>
<script type="text/javascript" src="/hj/menu/js/vue.js"></script>
<script type="text/javascript" src="/hj/menu/js/menu.js"></script>
