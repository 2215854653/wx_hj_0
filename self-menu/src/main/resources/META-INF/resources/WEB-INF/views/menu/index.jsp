...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/hj_0/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/hj_0/menu/js/jquery.js"></script>
<script type="text/javascript" src="/hj_0/menu/js/vue.js"></script>
<script type="text/javascript" src="/hj_0/menu/js/menu.js"></script>
